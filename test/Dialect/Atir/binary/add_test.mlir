...
func @atir_add_test_scalar_noret(%arg0: tensor<f32>, %arg1: tensor<f32>) {
  // CHECK: atir.add %arg0, %arg1 : (tensor<f32>, tensor<f32>) -> tensor<f32>
...
func @atir_add_test_unknown_shape_same_rank(%arg0: tensor<?xf32>, %arg1: tensor<?xf32>, %arg2: tensor<?x?xf32>, %arg3: tensor<?x?xf32>) {
  // CHECK: atir.add %arg0, %arg1 : (tensor<?xf32>, tensor<?xf32>) -> tensor<?xf32>
  // CHECK: atir.add %arg2, %arg3 : (tensor<?x?xf32>, tensor<?x?xf32>) -> tensor<?x?xf32>
  %0 = atir.add %arg0, %arg1 : (tensor<?xf32>, tensor<?xf32>) -> tensor<?xf32>
...
// unknown shape tensor with same rank
func @atir_add_test_same_shape_same_rank(%arg0: tensor<8xf32>, %arg1: tensor<8xf32>, %arg2: tensor<16x2xf32>, %arg3: tensor<16x2xf32>) {
  // CHECK: atir.add %arg0, %arg1 : (tensor<8xf32>, tensor<8xf32>) -> tensor<8xf32>
  // CHECK: atir.add %arg2, %arg3 : (tensor<16x2xf32>, tensor<16x2xf32>) -> tensor<16x2xf32>
...
// the broadcast is from scalar.
func @atir_add_test_rhs_broadcast(%arg0: tensor<f32>, %arg1: tensor<?x13xf32>) -> tensor<?x13xf32> {
  // CHECK: atir.add %arg0, %arg1 : (tensor<f32>, tensor<?x13xf32>) -> tensor<?x13xf32>
  %0 = atir.add %arg0, %arg1 : (tensor<f32>, tensor<?x13xf32>) -> tensor<?x13xf32>
  return %0 : tensor<?x13xf32>
}


// CHECK-LABEL: func @atir_add_test_mixed_arg_same_rank
// expect success
func @atir_add_test_mixed_arg_same_rank(%arg0: tensor<13xf32>, %arg1: tensor<?xf32>) {
  // CHECK: atir.add %arg0, %arg1 : (tensor<13xf32>, tensor<?xf32>) -> tensor<?xf32>
  %0 = atir.add %arg0, %arg1 : (tensor<13xf32>, tensor<?xf32>) -> tensor<?xf32>
  return
}

// CHECK-LABEL: func @atir_add_test_mixed_arg_diff_rank
// expect failure
func @atir_add_test_mixed_arg_diff_rank(%arg0: tensor<13xf32>, %arg1: tensor<?x?xf32>) {
  // CHECK: atir.add %arg0, %arg1 : (tensor<13xf32>, tensor<?x?xf32>) -> tensor<?x?xf32>
  %0 = atir.add %arg0, %arg1 : (tensor<13xf32>, tensor<?x?xf32>) -> tensor<?x?xf32>
  return
}
