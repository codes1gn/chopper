...
using namespace mlir::CHOPPER::Basicpy;
using namespace mlir::CHOPPER::Typing;
...
public:
  ...
  LogicalResult runOnFunction(FuncOp funcOp) {
    ...
    auto result = funcOp.walk([&](Operation *childOp) -> WalkResult {
      ...
      if (auto opInt =
              dyn_cast<CHOPPERTypingCPATypeInferenceOpInterface>(childOp)) {
...
mlir::CHOPPER::Typing::createCPAFunctionTypeInferencePass() {
