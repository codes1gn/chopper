...
//===----------------------------------------------------------------------===//
//
// This is the base file for chopper's "reference backend".
//
...
void mlir::CHOPPER::registerRefBackendPasses() {
  ...
  mlir::PassPipelineRegistration<RefBackendLoweringPipelineOptions>(
      ...
      "just Ctir dialect).",
      mlir::CHOPPER::createRefBackendAtirToCtirPipeline);
  mlir::PassPipelineRegistration<RefBackendLoweringPipelineOptions>(
      ...
      mlir::CHOPPER::createAtirRefBackendLoweringPipeline);
}
...
mlir::CHOPPER::createLowerAllocMemRefOpsPass() {
...
std::unique_ptr<Pass> mlir::CHOPPER::createRestrictedCanonicalizerPass() {
...
void mlir::CHOPPER::createRefBackendLoweringPipeline(
...
void mlir::CHOPPER::createRefBackendAtirToCtirPipeline(
    OpPassManager &pm, const RefBackendLoweringPipelineOptions &options) {
...
void mlir::CHOPPER::createAtirRefBackendLoweringPipeline(
    OpPassManager &pm, const RefBackendLoweringPipelineOptions &options) {
