...
//!
//! ```no_run
//! # extern crate backend_boilerplate as backend;
//! # extern crate gfx_hal;
//! # fn main() {
//! # use gfx_hal::prelude::*;
//!
//! # let mut surface: backend::Surface = return;
//! # let device: backend::Device = return;
//! # let mut present_queue: backend::Queue = return;
//! # unsafe {
