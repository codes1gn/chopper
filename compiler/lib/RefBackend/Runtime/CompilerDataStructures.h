...
#ifndef CHOPPER_LIB_RUNTIME_COMPILERDATASTRUCTURES_H
#define CHOPPER_LIB_RUNTIME_COMPILERDATASTRUCTURES_H
...
#endif // CHOPPER_LIB_RUNTIME_COMPILERDATASTRUCTURES_H
