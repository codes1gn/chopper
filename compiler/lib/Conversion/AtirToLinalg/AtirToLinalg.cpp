...
static SmallVector<Value, 6> bypassResultShapes(Operation *op,
  ...
  if (auto matmul = dyn_cast<atir::MatmulOp>(op)) {
...
namespace {
class ConvertMatmul : public OpRewritePattern<atir::MatmulOp> {
public:
...
public:
  void getDependentDialects(DialectRegistry &registry) const override {
    registry
        .insert<shape::ShapeDialect, ctir::CtirDialect, tensor::TensorDialect,
...
mlir::CHOPPER::createConvertAtirToLinalgPass() {
