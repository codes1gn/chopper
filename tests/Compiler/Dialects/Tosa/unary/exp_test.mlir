...
func @atir_exp_test_tensor_noret(%arg0: tensor<?xf32>) {
  ...
  %0 = "tosa.exp"(%arg0): (tensor<?xf32>) -> tensor<?xf32>
  return
}
...
func @atir_exp_test_shapedtensor_noret(%arg0: tensor<31xf32>) {
  // CHECK: "tosa.exp"(%arg0) : (tensor<31xf32>) -> tensor<31xf32>
  %0 = "tosa.exp"(%arg0): (tensor<31xf32>) -> tensor<31xf32>
  return
}
...
func @atir_exp_test_shapedtensor_ret(%arg0: tensor<17x16xf32>) -> tensor<17x16xf32>{
  ...
  %0 = "tosa.exp"(%arg0): (tensor<17x16xf32>) -> tensor<17x16xf32>
