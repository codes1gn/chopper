...
func @atir_mul_test_scalar_noret(%arg0: tensor<f32>, %arg1: tensor<f32>) {
  ...
  %0 = "tosa.mul"(%arg0, %arg1) {shift = 0 : i32} : (tensor<f32>, tensor<f32>) -> tensor<f32>
  return
}
...
func @atir_mul_test_tensor_ret(%arg0: tensor<?xf32>, %arg1: tensor<?xf32>) -> tensor<?xf32> {
  ...
  %0 = "tosa.mul"(%arg0, %arg1) {shift = 0 : i32} : (tensor<?xf32>, tensor<?xf32>) -> tensor<?xf32>
...
func @atir_mul_test_unknown_shape_same_rank(%arg0: tensor<?xf32>, %arg1: tensor<?xf32>, %arg2: tensor<?x?xf32>, %arg3: tensor<?x?xf32>) {
  ...
  %0 = "tosa.mul"(%arg0, %arg1) {shift = 0 : i32} : (tensor<?xf32>, tensor<?xf32>) -> tensor<?xf32>
  %1 = "tosa.mul"(%arg2, %arg3) {shift = 0 : i32} : (tensor<?x?xf32>, tensor<?x?xf32>) -> tensor<?x?xf32>
  return
}
...
func @atir_mul_test_same_shape_same_rank(%arg0: tensor<8xf32>, %arg1: tensor<8xf32>, %arg2: tensor<16x2xf32>, %arg3: tensor<16x2xf32>) {
  ...
  // CHECK: "tosa.mul"(%arg2, %arg3) {shift = 0 : i32} : (tensor<16x2xf32>, tensor<16x2xf32>) -> tensor<16x2xf32>
  %0 = "tosa.mul"(%arg0, %arg1) {shift = 0 : i32} : (tensor<8xf32>, tensor<8xf32>) -> tensor<8xf32>
  %1 = "tosa.mul"(%arg2, %arg3) {shift = 0 : i32} : (tensor<16x2xf32>, tensor<16x2xf32>) -> tensor<16x2xf32>
  return
}
...
func @atir_mul_test_lhs_broadcast(%arg0: tensor<?xf32>, %arg1: tensor<f32>) -> tensor<?xf32> {
  ...
  %0 = "tosa.mul"(%arg0, %arg1) {shift = 0 : i32} : (tensor<?xf32>, tensor<f32>) -> tensor<?xf32>
  return %0 : tensor<?xf32>
}
...
func @atir_mul_test_rhs_broadcast(%arg0: tensor<f32>, %arg1: tensor<?x13xf32>) -> tensor<?x13xf32> {
  // CHECK: "tosa.mul"(%arg0, %arg1) {shift = 0 : i32} : (tensor<f32>, tensor<?x13xf32>) -> tensor<?x13xf32>
  %0 = "tosa.mul"(%arg0, %arg1) {shift = 0 : i32} : (tensor<f32>, tensor<?x13xf32>) -> tensor<?x13xf32>
...
func @atir_mul_test_mixed_arg_same_rank(%arg0: tensor<13xf32>, %arg1: tensor<?xf32>) {
  // CHECK: "tosa.mul"(%arg0, %arg1) {shift = 0 : i32} : (tensor<13xf32>, tensor<?xf32>) -> tensor<?xf32>
  %0 = "tosa.mul"(%arg0, %arg1) {shift = 0 : i32} : (tensor<13xf32>, tensor<?xf32>) -> tensor<?xf32>
  return
}
...
func @atir_mul_test_mixed_arg_diff_rank(%arg0: tensor<13xf32>, %arg1: tensor<?x?xf32>) {
  // CHECK: "tosa.mul"(%arg0, %arg1) {shift = 0 : i32} : (tensor<13xf32>, tensor<?x?xf32>) -> tensor<?x?xf32>
  %0 = "tosa.mul"(%arg0, %arg1) {shift = 0 : i32} : (tensor<13xf32>, tensor<?x?xf32>) -> tensor<?x?xf32>
  return
}
